...
import { createMotherboardSupabaseClient } from '@motherboard/shared';
...
if (!SUPABASE_URL || !SUPABASE_ANON_KEY) {
  ...
  console.warn(
    '[Motherboard] Missing EXPO_PUBLIC_SUPABASE_URL / EXPO_PUBLIC_SUPABASE_ANON_KEY. ' +
      'Copy .env.example to .env and fill in your Supabase project values.'
  );
}

export const supabase = createMotherboardSupabaseClient({
  url: SUPABASE_URL,
